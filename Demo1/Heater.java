...
public class Heater {
	...
	public static void main(String[] args) {
		double ULoss, uV, heatingLoad, timeRequired,temperatureHeating, temperatureZone;
		...
		heatingLoad = ULoss * (temperatureZone - temperatureHeating);	
		System.out.println("Required load to heat up the house: "+ heatingLoad);
		System.out.println("----------------------------------------------");
