...
public class ElectricCar extends JPanel{
	 ...
	 public static void ECmode(){
		 
		 Appliance newM = new Appliance();
		 
		 final ElectricCar formx = new ElectricCar();
	        // Frame for our test
		        ...
		        // Frame for our test
		        JFrame PANEL = new JFrame("ElectricCar");
