...
public class Dishwasher extends JPanel{
	 ...
	 public static void DWmode(){
		 
		 Appliance newM = new Appliance();
		 
		 final Dishwasher formx = new Dishwasher();
	        // Frame for our test
		        ...
		        // Frame for our test
		        JFrame PANEL = new JFrame("Dishwasher");
